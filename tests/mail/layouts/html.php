...
/*$bundle = \frontend\themes\ctstabil\assets\ThemeAsset::register($this);
			...
			<tr>
				...
				<td align="center" style="padding:7px 0">
					<table class="table" bgcolor="#ffffff" style="width:100%">
						<tr>
							<td align="center" class="logo" style="padding:7px 3px">
								<a title="<?= Yii::$app->name ?>" href="<?= Url::base(true)  ?>" style="color:#337ff1">
									<?php /*
									<img src="<?= $theme->getUrl('images/logo.png') ?>" alt="<?= Yii::$app->name ?>" />
									*/ ?>
								</a>
							</td>
						</tr>
						...
						<tr>
							<td class="footer" align="center" style="padding:7px 3px">
								<span><?php /*<?= Yii::t('app', Yii::$app->config->getAppConfig('copyright'), array('{name}' => Yii::$app->name));?> */?></span>
							</td>
						</tr>
					</table>
				</td>
