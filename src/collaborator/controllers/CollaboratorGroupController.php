<?php
namespace ant\collaborator\controllers;
...
class CollaboratorGroupController extends \yii\web\Controller {
    ...
    public function actionManage($id) {
        ...
        if (!$model->canAccessBy(\Yii::$app->user->id)) throw new \yii\web\ForbiddenHttpException('Access Denied. ');
    ...
    public function actionDeleteCollaborator($id) {
        ...
        $model->delete();
        return $this->redirect(['/collaborator/collaborator-group/manage', 'id' => $model->collaborator_group_id]);
    }
}